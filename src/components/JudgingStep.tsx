          ...
          <aside className="audit-panel hidden rounded-lg p-4 lg:block">
            ...
            <div className="mt-3 rounded border border-amber-500/35 bg-amber-500/10 px-2.5 py-2 font-mono text-[10px] text-amber-200">
              <div className="flex items-start gap-1.5">
                ...
                <span>
                  {activeComplication
                    ? t('judge.potentialContradiction')
                    : t('judge.noContradictionAlert')}
                </span>
              </div>
            </div>
            <div className="mt-4 font-mono text-[9px] uppercase tracking-[0.18em] text-slate-500">
              audit_flow
            </div>
