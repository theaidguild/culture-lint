const enUS = {
  translation: {
    ...
    session: {
      ...
      title: 'Step 2: Run the Scenario Gauntlet',
      description:
        'A single test is easy to game. This session shuffles multiple scenarios so it is hard to notice when you apply two different standards to the same act.',
      briefingTitle: 'WHY MULTIPLE SCENARIOS?',
      briefingBody:
        'Each scenario presents two structurally identical acts performed by different actors. Facing several of them back-to-back makes an inconsistent moral judgment far harder to hide.',
      seedLabel: '[SESSION_SEED]',
      seedHint: 'The seed fully determines scenario order. Same seed = same session. Share the link to reproduce it exactly.',
      newSeed: 'NEW SEED',
      copyLink: 'COPY LINK',
      copied: 'COPIED',
      queueTitle: '[SCENARIO_QUEUE]',
      queueCount: '// {{count}} scenarios queued',
      run: 'RUN SESSION',
      running: 'RUNNING GAUNTLET...',
    },
    sessionResult: {
      title: 'Step 3: Session Results',
      summaryFailed: '{{failed}} of {{total}} scenarios exposed a double standard.',
      summaryClean: 'All {{total}} scenarios passed. Your judgments were consistent.',
      seedUsed: 'SEED: {{seed}}',
