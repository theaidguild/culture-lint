const enUS = {
  translation: {
    ...
    aiStatus: {
      ...
      loadingMonitorTitle: 'AI loading monitor',
      ...
      idle: 'idle',
      copy: 'Copy',
      safeModeActiveHint: 'Safe mode active: the app skips automatic warmup on mobile.',
      noActivity: 'No active AI work right now.',
