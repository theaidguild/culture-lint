const ptBR = {
  translation: {
    ...
    progress: {
      ...
      runGauntlet: 'Rodada de cenários',
    ...
    session: {
      ...
      title: 'Etapa 2: Rode a sequência de cenários',
      description:
        'Um teste único é fácil de burlar. Esta sessão embaralha vários cenários para dificultar perceber quando você aplica dois pesos e duas medidas ao mesmo ato.',
      briefingTitle: 'POR QUE VÁRIOS CENÁRIOS?',
      briefingBody:
        'Cada cenário apresenta dois atos estruturalmente idênticos praticados por atores diferentes. Enfrentar vários deles em sequência torna muito mais difícil esconder um julgamento moral inconsistente.',
      seedLabel: '[SEED_DA_SESSAO]',
      seedHint: 'A seed determina totalmente a ordem dos cenários. Mesma seed = mesma sessão. Compartilhe o link para reproduzi-la exatamente.',
      newSeed: 'NOVA SEED',
      copyLink: 'COPIAR LINK',
      copied: 'COPIADO',
      queueTitle: '[FILA_DE_CENARIOS]',
      queueCount: '// {{count}} cenários na fila',
      run: 'RODAR SESSÃO',
      running: 'RODANDO CENÁRIOS...',
    },
    sessionResult: {
      title: 'Etapa 3: Resultados da sessão',
      summaryFailed: '{{failed}} de {{total}} cenários expuseram um duplo padrão.',
      summaryClean: 'Todos os {{total}} cenários passaram. Seus julgamentos foram consistentes.',
      seedUsed: 'SEED: {{seed}}',
